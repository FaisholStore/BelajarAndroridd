...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Dapatkan referensi ke CircleImageView
        profileCircleImageView = navView.getHeaderView(0).findViewById(R.id.imageView)

        // Ambil ID gambar profil dari drawable (gantilah dengan nama gambar yang sesuai)
        val profileImageResource = R.drawable.profile

        // Set gambar profil ke CircleImageView
