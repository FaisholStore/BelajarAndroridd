...
class FollowingView : ViewModel() {
    ...
    val followers: LiveData<ArrayList<User>> get() = _following
    ...
    fun setFollowingByUsername(username: String) {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (followersList != null) {
                        _following.postValue(followersList)
    ...
    fun getFollowingByUsername(): LiveData<ArrayList<User>> {
        return _following
    }
