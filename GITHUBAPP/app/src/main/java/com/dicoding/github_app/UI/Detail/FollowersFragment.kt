...
class FollowersFragment : Fragment(R.layout.fragment_follow) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        showLoading(true)
        viewModel = ViewModelProvider(this,ViewModelProvider.NewInstanceFactory()).get(FollowersView::class.java)
        // Panggil fungsi untuk mendapatkan daftar pengikut berdasarkan username
        viewModel.setFollowersByUsername(username)

        viewModel.getFollowersByUsername().observe(viewLifecycleOwner){followersList ->
